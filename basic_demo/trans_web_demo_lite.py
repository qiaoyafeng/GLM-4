...
MODEL_PATH = os.environ.get('MODEL_PATH', '/opt/GLM-4/basic_demo/lf_checkpoint-68400')
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            max_length = gr.Slider(0, 32768, value=8192, step=1.0, label="Maximum length", show_label=False, visible=False, interactive=True)
            top_p = gr.Slider(0, 1, value=0.8, step=0.01, label="Top P", show_label=False, visible=False, interactive=True)
            temperature = gr.Slider(0.01, 1, value=0.6, step=0.01, label="Temperature", show_label=False, visible=False, interactive=True)
...
demo.queue()
demo.launch(server_name="127.0.0.1", server_port=32102, inbrowser=True, share=True)
